...
// Proses dekripsi
if (isset($_POST['decrypt_text']) && !empty($_POST['encrypted_text'])) {
    $cipherText = base64_decode($_POST['encrypted_text']); // Decode sebelum mendekripsi
    $decryptedText = des_decrypt($cipherText);
}
...
<head>
    ...
    <link rel="stylesheet" href="CSS/dekripsiTeks.css">
</head>
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-body">
                    <h5 class="mb-4 text-center fw-bold text-dark">Dekripsi Pesan</h5>
                    <form method="POST" class="mb-3">
                        <div class="mb-3">
                            <input type="text" id="encrypted_text" name="encrypted_text" class="form-control" placeholder="Masukan Teks">
                        </div>
                        <div class="text-center mt-3">
                            <button type="submit" name="decrypt_text" class="btn btn-warning text-white">Dekripsi</button>
                        </div>
                    </form>
                    <div class="alert text-dark">
                        <strong>Hasil Dekripsi:</strong> <?php echo htmlspecialchars($decryptedText); ?>
                    </div>
                </div>
            </div>
        </div>
